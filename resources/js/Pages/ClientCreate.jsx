                    ...
                    <div className="bg-white overflow-hidden shadow-xl sm:rounded-xl border-t-4 border-gradient-to-r from-green-600 to-yellow-400">
                        <div className="p-8">
                            <div className="mb-8">
                                ...
                                <p className="text-gray-600">Create a new client for your projects</p>
                            </div>
                                ...
                                {form.data.name && (
                                    <div className="p-4 bg-gradient-to-r from-green-50 to-yellow-50 rounded-lg border border-green-200">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <p className="text-sm text-gray-600">New Client Preview:</p>
                                                <p className="font-semibold text-green-700">{form.data.name}</p>
                                            </div>
                                        </div>
                                    </div>
                                )}
