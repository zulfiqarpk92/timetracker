...
export default function ProjectEdit({ auth, project, clients = [] }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="font-semibold text-xl text-slate-100 leading-tight">Edit Project</h2>}>
                    ...
                    <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl overflow-hidden shadow-2xl rounded-2xl border border-white/10">
                        <div className="p-8 relative">
                            <div className="mb-8">
                                ...
                                <p className="text-white/70 text-lg">Update project details and reassign client if needed</p>
                            </div>
